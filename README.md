...
```
wget -O install_exporters.sh https://raw.githubusercontent.com/Mhieu14/cosmos_node_monitoring/master/install_exporters.sh && chmod +x install_exporters.sh && ./install_exporters.sh
```
